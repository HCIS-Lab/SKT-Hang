...
def create_attachment(parent, parent_link, child, child_link=BASE_LINK):
    ...
    child_link_pose = get_link_pose(child, child_link)
    grasp_pose = multiply(invert(parent_link_pose), child_link_pose)
