...
if [ $1 = 'train' ]; then 
    ...
    do
        ...
        if [ $log = 'save' ]; then 
            ...
            CUDA_VISIBLE_DEVICES=0 python3 run_vatmart.py --dataset_dir $traj_recon_affordance_dataset --training_tag $training_tag --config "../config/vatmart/${model_config}.yaml" > $output_log
            # python3 plot_history.py $output_log

        else 

            python3 run_vatmart.py --dataset_dir $traj_recon_affordance_dataset --training_tag $training_tag --config "../config/vatmart/${model_config}.yaml"
    ...
    traj_recon_shape_checkpoints=(
        "checkpoints/vatmart_3dof_10wpts/kptraj_all_smooth-absolute-10-k0-05.02.20.53-1000-singleview"
        "checkpoints/vatmart_3dof_10wpts/kptraj_all_smooth-residual-10-k0-05.02.20.53-1000-singleview"
        "checkpoints/vatmart_3dof_20wpts/kptraj_all_smooth-absolute-20-k0-05.02.20.39-1000-singleview"
        "checkpoints/vatmart_3dof_20wpts/kptraj_all_smooth-residual-20-k0-05.02.20.39-1000-singleview"
        "checkpoints/vatmart_3dof_40wpts/kptraj_all_smooth-absolute-40-k0-05.02.20.23-1000-singleview"
        "checkpoints/vatmart_3dof_40wpts/kptraj_all_smooth-residual-40-k0-05.02.20.23-1000-singleview"

        "checkpoints/vatmart_6dof_10wpts/kptraj_all_smooth-absolute-10-k0-05.02.20.53-1000-singleview"
        "checkpoints/vatmart_6dof_10wpts/kptraj_all_smooth-residual-10-k0-05.02.20.53-1000-singleview"
        "checkpoints/vatmart_6dof_20wpts/kptraj_all_smooth-absolute-20-k0-05.02.20.39-1000-singleview"
        "checkpoints/vatmart_6dof_20wpts/kptraj_all_smooth-residual-20-k0-05.02.20.39-1000-singleview"
        "checkpoints/vatmart_6dof_40wpts/kptraj_all_smooth-absolute-40-k0-05.02.20.23-1000-singleview"
        "checkpoints/vatmart_6dof_40wpts/kptraj_all_smooth-residual-40-k0-05.02.20.23-1000-singleview"
    )
    ...
    do
        ...
        # do 
            ...
            python3 run_vatmart.py --training_mode 'inference' \
                                    --inference_dir ${inference_dirs[$i]} \
                                    --checkpoint_dir ${traj_recon_shape_checkpoints[$i]} \
                                    --config "../config/vatmart/${model_configs[$i]}.yaml" \
